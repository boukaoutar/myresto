...
export default ({
  subheading = "Télécharger l'application",
  text = "Les gens autour de vous commandent de délicieux repas en utilisant MyResto App",
  link1Text = "App Store",
